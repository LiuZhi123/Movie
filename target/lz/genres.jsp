                    ...
                    <div class="browse-inner">
                        <c:forEach items="${action}" var="movie">
                            <div class="col-md-2 w3l-movie-gride-agile">
                                <a href="single.html" class="hvr-shutter-out-horizontal"><img src="images/${movie.moviepic}" title="album-name" class="img-responsive" alt=" " />
                                    <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
                                </a>
                                <div class="mid-1">
                                    <div class="w3l-movie-text">
                                        <h6><a href="single?movieid=${movie.movieid}">${movie.moviename}</a></h6>
                                    </div>
                                    <div class="mid-2">
                                        <p>${movie.movieyear}</p>
